...
float64 height"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.brake.state_string = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.gripper.state_string = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.height.state_string = str[start:end].decode('utf-8', 'rosmsg')
      else:
