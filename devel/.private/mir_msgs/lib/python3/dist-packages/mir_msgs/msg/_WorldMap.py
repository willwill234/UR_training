...
float64 z"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.positions.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.areas.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.robots.header.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      for i in range(0, length):
        ...
        if python3:
          val1.footprint = str[start:end].decode('utf-8', 'rosmsg')
        else:
