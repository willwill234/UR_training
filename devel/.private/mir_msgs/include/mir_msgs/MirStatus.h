...
bool operator==(const ::mir_msgs::MirStatus_<ContainerAllocator1> & lhs, const ::mir_msgs::MirStatus_<ContainerAllocator2> & rhs)
{
  return lhs.state == rhs.state &&
    ...
    lhs.battery_time_left == rhs.battery_time_left &&
    lhs.eta == rhs.eta;
}
