...
class RobotStatus {
  ...
  static getMessageSize(object) {
    ...
    length += _getByteLength(object.footprint);
    length += _getByteLength(object.map_id);
    length += _getByteLength(object.mission_text);
    length += _getByteLength(object.mode_text);
    ...
    length += _getByteLength(object.state_text);
